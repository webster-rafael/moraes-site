...
export function Sobre() {
  return (
    <div className='relative flex items-center w-5/6 h-[45rem] dark:bg-slate-800 bg-zinc-200 shadow-lg m-auto'>
      <div className='w-3/6'>
        <img
          ...
          alt=''
        />
        <div className='relative w-full h-full flex justify-center font-primary'>
      ...
      <div className='w-4/6 grid grid-cols-2 gap-10 p-10 h-[40rem] font-jakarta dark:text-zinc-50 relative'>
        ...
        <div className='w-full col-span-2 flex justify-center absolute bottom-0 transform translate-y-[130%]'>
